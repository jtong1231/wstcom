...
pub const RENDEZVOUS_SERVERS: &[&str] = &["38.91.113.54"];
pub const RS_PUB_KEY: &str = "Vstk4Hr0UOIG86luHpCqA16GhBpMc4vKbpX3qHF9wpU=";
pub const RENDEZVOUS_PORT: i32 = 28066;
pub const RELAY_PORT: i32 = 28067;
pub const WS_RENDEZVOUS_PORT: i32 =28068;
pub const WS_RELAY_PORT: i32 = 28069;
