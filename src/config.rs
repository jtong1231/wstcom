...
lazy_static::lazy_static! {
    ...
    pub static ref APP_NAME: RwLock<String> = RwLock::new("畅向云".to_owned());
...
pub const RENDEZVOUS_SERVERS: &[&str] = &["38.91.113.52"];
pub const RS_PUB_KEY: &str = "Vstk4Hr0UOIG86luHpCqA16GhBpMc4vKbpX3qHF9wpU=";
pub const RENDEZVOUS_PORT: i32 = 28366;
pub const RELAY_PORT: i32 = 28367;
pub const WS_RENDEZVOUS_PORT: i32 =28368;
pub const WS_RELAY_PORT: i32 = 28369;
