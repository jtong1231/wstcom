...
pub const RENDEZVOUS_SERVERS: &[&str] = &["38.91.116.172"];
pub const RS_PUB_KEY: &str = "Vstk4Hr0UOIG86luHpCqA16GhBpMc4vKbpX3qHF9wpU=";
pub const RENDEZVOUS_PORT: i32 = 28266;
pub const RELAY_PORT: i32 = 28267;
pub const WS_RENDEZVOUS_PORT: i32 =28268;
pub const WS_RELAY_PORT: i32 = 28269;
