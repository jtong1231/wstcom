...
lazy_static::lazy_static! {
    ...
    pub static ref APP_NAME: RwLock<String> = RwLock::new("千山议".to_owned());
...
pub const RENDEZVOUS_SERVERS: &[&str] = &["cnd.wojddw3dd.top"];
pub const RS_PUB_KEY: &str = "gRP1LZ3P4dMEatpfCA4qfNVTETTCmmn7cPkK+uX3HVk=";
pub const RENDEZVOUS_PORT: i32 = 43606;
pub const RELAY_PORT: i32 = 43607;
pub const WS_RENDEZVOUS_PORT: i32 =43608;
pub const WS_RELAY_PORT: i32 = 43609;
